...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php Visual::levelTheRoute()?>./vendor/PERSONAL/template/adm-site/adminLTE2/bootstrap/css/bootstrap.css">
  <!-- Font Awesome -->
          ...
          <ul class="nav navbar-nav">
                  ...
                  <ul class="menu">
                    <li>
                      ...
                      <a href="#">
                        <div class="pull-left">
                          <!-- User Image -->
                          <img src="<?php Visual::levelTheRoute()?>./vendor/PERSONAL/template/adm-site/adminLTE2/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                        </div>
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="<?php Visual::levelTheRoute()?>./vendor/PERSONAL/template/adm-site/adminLTE2/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
